...
PJSK（プロジェクトセカイ / 世界计划）音乐游戏猜曲 **Wordle** 插件，本项目的玩法和界面借鉴自watagashi-uni的宵崎奏Bot。

## 玩法

游戏开始后，bot 会从题库中随机选定一首目标歌曲，
玩家 **@机器人 + 曲名或别名** 进行回答，共 **8 次**机会（未 @ 机器人的消息不参与游戏）。匹配规则：
...
**计分**：第 1-2 次猜对得 4 分，3-4 次得 3 分，5-6 次得 2 分，7-8 次得 1 分。
